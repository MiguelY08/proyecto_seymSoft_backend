...
/**
 * Valida el ID de un banner para obtenerlo
 * 
 ...
 */
export const validateGetBannerById = (data) => {
  try {
    const validated = getBannerByIdSchema.parse(data);
 ...
 */
export const validateGetBannerByIdValidator = validateGetBannerById;