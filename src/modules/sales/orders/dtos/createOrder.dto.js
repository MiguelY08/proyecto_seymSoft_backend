export class CreateOrderDto {
  constructor(data) {
    ...
    this.orderStatusId = data.orderStatusId ?? 1;
  ...
  throw new Error('El cliente es obligatorio.');
    ...
    for (const item of this.items) {
      if (!item.idProduct) throw new Error('Cada item debe tener producto.');
      if (!item.barcode) throw new Error('Cada item debe tener código de barras.');
