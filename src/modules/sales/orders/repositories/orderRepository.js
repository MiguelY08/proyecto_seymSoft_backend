...
const orderSummarySelect = {
  ...
  order_payment_receipts: {
    select: {
      ...
      ai_amount: true,
      ai_currency: true,
      ai_transaction_reference: true,
      ai_transaction_date: true,
      ai_transaction_time: true,
      ai_bank: true,
      ai_sender_name: true,
      ai_recipient_name: true,
      ai_status: true,
      ai_warnings: true,
      ai_error: true,
      ai_raw_text: true,
  ...
  async createPaymentReceipt(idOrder, data) {
    return prisma.order_payment_receipts.create({
      data: {
        ...
        observations: data.observations || null,
        verification_status: PAYMENT_RECEIPT_STATUSES.PENDING,
        ai_analysis_status: data.analysis?.status || 'No analizado',
        ai_analyzed_at: data.analysis?.analyzedAt || null,
        ai_model: data.analysis?.model || null,
        ai_confidence: data.analysis?.confidence ?? null,
        ai_amount: data.analysis?.amount ?? null,
        ai_currency: data.analysis?.currency || null,
        ai_transaction_reference: data.analysis?.transactionReference || null,
        ai_transaction_date: data.analysis?.transactionDate || null,
        ai_transaction_time: data.analysis?.transactionTime || null,
        ai_bank: data.analysis?.bank || null,
        ai_sender_name: data.analysis?.senderName || null,
        ai_recipient_name: data.analysis?.recipientName || null,
        ai_status: data.analysis?.statusText || null,
        ai_warnings: data.analysis?.warnings || [],
        ai_error: data.analysis?.error || null,
        ai_raw_text: data.analysis?.rawText || null,
      },
