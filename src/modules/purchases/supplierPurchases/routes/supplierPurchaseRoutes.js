...
// GET   /api/supplier-purchases              → lista paginada con filtros
// POST  /api/supplier-purchases              → crear compra + detalles + actualiza stock
// GET   /api/supplier-purchases/:id          → detalle con productos
// PATCH /api/supplier-purchases/:id/annul    → anular compra + revierte stock
